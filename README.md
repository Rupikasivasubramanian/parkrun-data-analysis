## Parkrun Data Analysis - Puma Marketing Report

Group project analysing parkrun data from 7 Christchurch 
locations to identify marketing opportunities for Puma.
...
### My contributions
- Data cleaning and creating final dataset
- Analysis questions 1, 2 and 3
  - Unique runners per location
  - New vs returning runner trends
  - Runner overlap between locations
- Technical report writing

### Team
- Rupika Sivasubramanian
- Raman Preet Singh
- Huizhi Zhang
